package devonfw.com.jwtsample.general.service.impl.rest;
...
import devonfw.com.jwtsample.general.common.api.to.UserProfileTo;
import devonfw.com.jwtsample.general.service.api.rest.SecurityRestService;
import devonfw.com.jwtsample.general.service.base.test.RestServiceTest;
...
public class SecurityRestServiceImplTest extends RestServiceTest {
   ...
   * @return @ {@link ResponseEntity} containing containing a cookie in its
   *         header.
   */
  private ResponseEntity<String> login(String userName, String tmpPassword) {
    ...
    HttpEntity<String> postRequest = new HttpEntity<>(
        "{\"username\": \"" + userName + "\", \"password\": \"" + tmpPassword + "\"}", new HttpHeaders());
