...
import devonfw.com.jwtsample.general.logic.impl.config.DefaultRolesPrefixPostProcessor;

/**
 * This configuration class provides factory methods for several Spring security
 * related beans.
 *
 */
@Configuration
public class WebSecurityBeansConfig {
  ...
  /**
   * This method provides a new instance of
   * {@code DefaultRolesPrefixPostProcessor}
   *
  ...
  public static DefaultRolesPrefixPostProcessor defaultRolesPrefixPostProcessor() {
    ...
    // By default Spring-Security is setting the prefix "ROLE_" for all
