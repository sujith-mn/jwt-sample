...
public class WebConfig {
  ...
  /**
   * @return the {@link FilterRegistrationBean} to register the
   *         {@link PerformanceLogFilter} that will log all requests with their
  ...
  /**
   * @return the {@link FilterRegistrationBean} to register the
   *         {@link DiagnosticContextFilter} that adds the correlation id as MDC
   *         so it will be included in all associated logs.
   */
  @Bean
  ...
  /**
   * @return the {@link FilterRegistrationBean} to register the
   *         {@link CharacterEncodingFilter} to set the encoding.
   */
  @Bean
