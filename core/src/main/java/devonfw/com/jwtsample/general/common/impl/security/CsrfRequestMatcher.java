package devonfw.com.jwtsample.general.common.impl.security;
...
/**
 * This is the implementation of {@link RequestMatcher}, which decides which
 * {@link HttpServletRequest Requests} require a correct CSRF token.
 *
 * @see <a href=
...
public class CsrfRequestMatcher implements RequestMatcher {
  ...
  public boolean matches(HttpServletRequest request) {
    ...
    // There are specific URLs which can not be protected from CSRF. For example, in
    // case of the the login page,
    // the CSRF token can only be accessed after a successful authentication
    // ("login").
