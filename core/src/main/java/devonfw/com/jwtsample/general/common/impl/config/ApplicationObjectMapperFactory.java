package devonfw.com.jwtsample.general.common.impl.config;
...
/**
 * The MappingFactory class to resolve polymorphic conflicts within the
 * devonfw.com.jwtsample application.
 */
...
public class ApplicationObjectMapperFactory extends ObjectMapperFactory {
  ...
  public ApplicationObjectMapperFactory() {
    ...
    super();
    // see
    // https://github.com/devonfw-wiki/devon4j/wiki/guide-json#json-and-inheritance
  ...
  public ObjectMapper createInstance() {
    ...
    // is not yet updated
    // see
    // https://github.com/devonfw-wiki/devon4j/wiki/guide-service-layer#versioning
