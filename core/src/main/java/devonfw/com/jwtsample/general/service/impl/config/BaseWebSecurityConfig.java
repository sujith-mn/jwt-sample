package devonfw.com.jwtsample.general.service.impl.config;
...
import devonfw.com.jwtsample.general.security.JWTAuthenticationFilter;
import devonfw.com.jwtsample.general.security.JWTLoginFilter;
...
public abstract class BaseWebSecurityConfig extends WebSecurityConfigurerAdapter {
  ...
  public void configure(HttpSecurity http) throws Exception {
    ...
    http
        //
        .userDetailsService(this.userDetailsService).csrf().disable().exceptionHandling().and().sessionManagement()
        ...
        .addFilterBefore(new JWTLoginFilter("/services/rest/login", authenticationManager()),
        ...
        // .passwordParameter(
        // "password"); /*
        // * .and() // logout via POST is possible
