package devonfw.com.jwtsample.general.dataaccess.api;
 ...
 * with an {@link #getId() id} and a {@link #getModificationCounter()
 * modificationCounter} (version) field. All persistence entities of this
 * application should inherit from this class. It is using JPA annotations at
 * the getters what has several advantages but also implies that you have to
 * annotate transient getter methods with the {@link Transient} annotation.
 */
@MappedSuperclass
