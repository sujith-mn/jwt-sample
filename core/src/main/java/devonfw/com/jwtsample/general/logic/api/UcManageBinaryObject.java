package devonfw.com.jwtsample.general.logic.api;
...
public interface UcManageBinaryObject {
  ...
  /**
   * @param binaryObjectId the ID of the {@link BinaryObjectEto} that should be
   *                       deleted
   */
  ...
  /**
   * @param binaryObjectId the ID of the {@link BinaryObjectEto} the blob
   *                       corresponds to
   * @return {@link Blob}
   */
